...
async def signup(payload: SignUpRequest, session: AsyncSession = Depends(get_session)) -> UserResponse:
...
async def refresh_tokens(payload: RefreshTokenRequest, session: AsyncSession = Depends(get_session)) -> TokenResponse:
...
@router.post("/logout")
async def logout(payload: RefreshTokenRequest, session: AsyncSession = Depends(get_session)) -> dict[str, str]:
