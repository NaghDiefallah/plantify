...
const PRODUCTION_API_URL = process.env.NEXT_PUBLIC_PRODUCTION_API_URL?.trim() || process.env.NEXT_PUBLIC_API_BASE_URL?.trim() || "https://api.plantify.limarise.com/api";
